...
return [
   ...
   'attributes' => [
    ...
    'common' => [
        ...
        'password_confirm' => [
            'required' => '新しいパスワード（確認用）を入力して下さい',
            'invalid' => '大文字と英数字を含んだ、6～15文字以内で設定して下さい',
            'not_match' => '新しいパスワードと同じパスワードを入力して下さい',
        ],
        'name' => [
        ...
        'amount' => [
            'min' => '最低金額以上を入力して下さい。',
            'max' => '最大金額以下を入力して下さい。',
            'db_not_found' => '選択された通貨情報がまだ設定されていないです。ご確認下さい。',
            'number_invalid' => '半角数字を入力して下さい。'
        ],
        'checkKatakana' => '全角カタカナを入力して下さい。'
    ],
