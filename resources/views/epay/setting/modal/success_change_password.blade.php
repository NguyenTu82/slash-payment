{{-- modal result --}}
<div class="modal fade common-modal common-modal-confirm" id="success-change-password-modal" aria-hidden="true"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body confirmm">
                ...
                <p class="desc"> {{ __('common.setting.profile.change_pw_successful') }} </p>
