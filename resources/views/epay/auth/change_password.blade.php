                        ...
                        <div class="card-body login-card-body pt-3">
                            @if($status == "done")
                                ...
                                <p class="mb-1 help-block text-center button-success justify-content-center d-flex">
                                    <button class="btn bg-primary background-button rounded-pill p-2">
                            ...
                            @else
                                ...
                                <form role="form" class="form-change-pass" id="quickForm" method="POST"
                                      action="{{ route('admin_epay.auth.change_password') }}">
                                    @csrf
