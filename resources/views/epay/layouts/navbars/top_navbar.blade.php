...
>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item mx-1">
            <a
                class="nav-link info-user-name"
                href="#"
                id="user-name"
            >
                <span>{{__('common.navbar.username')}} : </span>
        ...
        <li class="nav-item logout">
            <a
                class="nav-link"
                href="{{route('admin_epay.auth.logout')}}"
                role="button"
                aria-haspopup="true"
                aria-expanded="false"
            >
                <button
                    type="button"
                    class="btn btn-logout btn-outline-primary"
                    style="text-align: center"
                >
                    {{__('common.navbar.logout')}}
                </button>
            </a>
        </li>
    </ul>
