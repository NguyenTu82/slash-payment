        ...
        >
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('admin_epay.report.transaction_info_detail') }}</h5>
                </div>
                                    ...
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        @foreach ($payment_info as $item)
                                            ...
                                            @foreach($item as $data)
                                                <tr>
                                                    <td>
                                                        <div class="center-table">@if($data['asset'] != 'total') {{ $data['asset'] }} @else {{ __('admin_epay.report.total') }} @endif </div>
                                                    </td>
                                                    <td>
