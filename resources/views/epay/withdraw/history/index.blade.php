        ...
        <div class="col-12">
            <div class="card card-mer-dash-table">
                <div class="title-csv d-flex flex-row justify-content-between">
                    ...
                    <button class="btn btn-primary btn-csv" id="export-csv-btn">CSV</button>
                </div>
                <!-- Card Body -->
                                    ...
                                    @foreach ($histories as $history)
                                        <tr>
                                            <td class="text-number-font">
                                                <a class="show-popup-data rule rule_epay_withdraw_detail"
                                                    href="{{ route('admin_epay.withdraw.history.detail.get', ['id' => $history->id]) }}">
                                                    {{ $history->id }}
                                                </a>
                                            </td>
                                            <td>
                                                <a class="show-popup-data rule rule_epay_withdraw_detail"
                                                    href="{{ route('admin_epay.merchantStore.detail', ['id' => $history->merchant_store_id]) }}">
