            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="profile-box">
                    <div class="account bg-white">
                        <form class="form-detail form-dropdown-input" action="{{ route('admin_epay.notification.send_edit.post',$notificationSend->id) }}" method="POST" id="editSendNotification">
                        @csrf
                                    ...
                                    <div class="select_info">
                                        ...
                                        @endphp
                                            <option value="{{NotiTypeSend::ALL->value}}"
                                                @if($notificationSend->type == NotiTypeSend::ALL->value)
                                                    selected
                                                @endif>
                                ...
                                <div class="form-group row form-item">
                                    ...
                                    <div class="col col-md-10 form-note-textarea border-erro">
                                        ...
                                        <div class="note-pass note-pass-select">
                                            <input type="hidden" name="store_latest" value="{{$notificationSend->dataMerchantName}}">
                                            ...
                                            @include('common.modal.select_merchant', [
                                                ...
                                                'selectedStores' => $notificationSend->dataMerchantId,
                                            ])
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col col-md-10 form-edit-input">
                                    <div class="turnoff-datetime">
                                        <div class="switch-span-content">
                                            <label class="switch">
                                                <input type="checkbox" checked id="toggle" name="is_has_send_time" checked >
                                        ...
                                        <input class="date-time input_time" type="datetime-local" value="{{$notificationSend->schedule_send_date}}" id="datetime" name="schedule_send_date">
                                    </div>
                            ...
                            <div class="form-group row form-item">
                                ...
                                <div class="col col-md-10 form-edit-input" >
                                    <input type="text" name="title" class="form-control {{ $errors->has('title') ? 'border-error' : '' }}" value="{{$notificationSend->title}}">
                                    <div class="note-pass"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row form-item noti-content-detail">
                                ...
                                <div class="col col-md-10 form-editor-input">
                                    <div class="editor-custom">
                                        <input type="hidden" id="quillHtml" name="content" value="{{$notificationSend->content}}"/>
                                        <div id="editor"></div>
                                    </div>
                            ...
                            <div class="form-group row form-item">
                                ...
                                <div class="col col-md-10">
                                    <div class="button-action">
                                        ...
                                        <a href="{{ route('admin_epay.notification.send_detail.get',$notificationSend->id) }}">
                        ...
                        @include('common.modal.confirm', [
                            'title' => __('admin_epay.notifications.common.title_confirm_update_send_noti'),
                            'description' => __('admin_epay.notifications.common.content_confirm_update_send_noti'),
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        var formattedCurrentTime = currentTime.toISOString().slice(0, 16);
        ...
        const EDIT_SEND_NOTIFICATION_FORM = $('#editSendNotification');
        ...
        $(document).ready(function () {
            ...
            SUBMIT_BUTTON_COMMON.on('click', function () {
                EDIT_SEND_NOTIFICATION_FORM[0].submit();
            });
            ...
            EDIT_SEND_NOTIFICATION_FORM.validate({
                rules: {
                    schedule_send_date: {
                        required: function () {
            ...
            var newValue = "{{$notificationSend->content}}".replace(/&lt;/g, "<").replace(/&gt;/g, ">");
            quill.setContents(quill.clipboard.convert(newValue));
            quill.on('text-change', function() {
                if ('<p><br></p>' == quill.root.innerHTML.trim()){
                    $('input[name=content]').parent().addClass('border-error');
                    $("#quillHtml").val(null)
                    let p = '<p id="quillHtml-error" class="error">{{__("admin_epay.notifications.validation.content.required")}}</p>'
                    $('input[name=content]').parent().parent().find('.note-pass').append(p)
                } else {
                    $("#quillHtml").val(quill.root.innerHTML.trim());
                    $('input[name=content]').parent().removeClass('border-error');
                    $('input[name=content]').parent().parent().find('#quillHtml-error').remove();
                }
            });
        });
    </script>
