                                ...
                                <div class="form-detail form-dropdown-input">
                                    ...
                                    <div class="form-group form-item info-detail-popup info-detail-popup-transfer">
                                        <div class="transfer-two-input-data">
                                            ...
                                            <input value="{{ $withdraw->bank_info['financial_institution_name'] ?? '' }}"
                                                   type="text"
                                        ...
                                        <div class="transfer-two-input-data transfer-two-input">
                                            ...
                                            <div class="info-input">
                                                <input value="{{ $withdraw->bank_info['bank_code'] ?? '' }}"
                                                       type="text"
                                    ...
                                    <div class="form-group form-item info-detail-popup info-detail-popup-transfer">
                                        <div class="transfer-two-input-data">
                                            ...
                                            <input value="{{ $withdraw->bank_info['branch_name'] ?? '' }}"
                                                   type="text"
                                                   class="form-control form-w300"
                                                   readonly>
                                        </div>
                                        ...
                                        <div class="transfer-two-input-data transfer-two-input">
                                            ...
                                            <div class="info-input">
                                                <input value="{{ $withdraw->bank_info['branch_code'] ?? '' }}"
                                                       type="text"
                                                       class="form-control form-w62"
                                                       readonly>
                                            </div>
                                    ...
                                    <div class="form-group form-item info-detail-popup info-detail-popup-transfer">
                                        <div class="transfer-two-input-data">
                                            ...
                                            @if(isset($withdraw->bank_info) and $withdraw->bank_info['bank_account_type'] == BankAccountType::USUALLY->value )
                                                <input value="{{ __('merchant.withdraw.bank_account_type.usually') }}"
                                                       type="text"
                                                       class="form-control form-w300"
                                                       readonly>
                                            @elseif(isset($withdraw->bank_info) and $withdraw->bank_info['bank_account_type'] == BankAccountType::REGULAR->value)
                                                <input value="{{ __('merchant.withdraw.bank_account_type.regular') }}"
                                                       type="text"
                                                       class="form-control form-w300"
                                                       readonly>
                                            @elseif(isset($withdraw->bank_info) and $withdraw->bank_info['bank_account_type'] == BankAccountType::CURRENT->value)
                                        ...
                                        <div class="transfer-two-input-data transfer-two-input">
                                            ...
                                            <div class="info-input">
                                                <input value="{{ $withdraw->bank_info['bank_account_number'] ?? '' }}"
                                                       type="text"
                                    ...
                                    <div class="form-group form-item info-detail-popup">
                                        ...
                                        <div class="info-input">
                                            <input value="{{ $withdraw->bank_info['bank_account_holder'] ?? '' }}"
                                                   type="text"
                                                   class="form-control"
                                                   readonly>
                                        </div>
