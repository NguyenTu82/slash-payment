@extends('merchant.layouts.auth.base', ['title' => __('auth.common.login.login')])
@push('script')
    ...
    <div class="h-100">
        <div class="container box-auth">
            <div class="container-fluid">
                ...
                <form
                    class="login-form"
                    action="{{ route('merchant.auth.login_process') }}"
                    method="post"
                    id="quickForm"
                >
                    @csrf
                    ...
                    <div class="form-group">
                        <input
                            ...
                            placeholder="{{ __('admin_epay.setting.profile.validation.email.required') }}"
                            value="{{old('email')}}"
                        />
                    ...
                    <div class="form-group">
                        <input
                            ...
                            placeholder="{{ __('validation.common.password.required') }}"
                            value=""
                        />
                    ...
                    <div class="row row-option-select">
                        ...
                        <div class="item-option-select option-forgot-password">
                            <p class="mb-1 forgot-password">
                                <a
                                    href="{{ route('merchant.auth.forgot_password') }}"
                ...
                <p class="text-center mt-3 register-btn custom-register">
                    <a
                        class="link-auth"
