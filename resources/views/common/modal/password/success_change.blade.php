<div class="popup-success">
    <div class="modal modal-success fade" id="success-change-password-modal-common" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-12 content-change-pass">
                            ...
                            <p class="title-change-pass">
                                {{ __('common.setting.profile.change_pw_successful') }}
                            </p>
                        </div>
                    </div>
                </div>
