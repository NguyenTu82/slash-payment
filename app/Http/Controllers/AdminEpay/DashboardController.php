...
class DashboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $baseTotalMerchantStores = $baseCond;
        unset($baseTotalMerchantStores['start_date']);
        ...
        $totalMerchantStores = $this->merchantStoreService->totalMerchantStores(
            (object) array_merge($baseTotalMerchantStores, [
                'status' => [
        ...
        $totalAffiliates = $this->affiliateAccountService->totalAffiliates(
            (object) array_merge($baseTotalMerchantStores, [])
        );
        ...
        // 2.2 both chart and table
        // $withdrawRequestCountInfo = $this->withdrawService->withdrawStatistic(
        //     (object) array_merge($baseCond, [
        //         'withdraw_request_method' => WithdrawRequestMethod::MANUAL->value,
        //     ])
        // );
        ...
        //     ])
        // );
        // 3.6 ~ 2.4 (total amount withdraw success Yen)
        ...
        return view('epay.dashboard.index', compact(
            'basePeriod',
        ));
    }
...
//        dd(
//            $totalMerchantStores,
//            $withdrawSuccessByYenFeeInfo->toArray()
//        );

        $html = view('epay.dashboard.modal.partial.main_content', compact(
            'totalTransactions',
